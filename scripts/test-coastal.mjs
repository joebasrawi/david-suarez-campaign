...
const resident=await read('resident-guide/index.html');
assert.ok(resident.includes('id="resident-film"'));
assert.ok(resident.includes('data-src="../assets/resident-beach.mp4"'));
assert.ok(resident.includes('resident-film.js?v='));
