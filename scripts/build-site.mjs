...
function footer(route) {
  const b = route ? '../' : './';
  return `<footer class="hub-footer"><div class="container"><div class="hub-footer-top"><div><strong class="footer-name">David Suarez</strong><p>Commissioner · Miami Beach Group 5</p><p>Not the official City website.</p></div><nav aria-label="Resident resources"><strong>For residents</strong><a href="${b}resident-guide/">Find a city service</a><a href="${b}news/">Miami Beach Today</a><a href="${b}meetings/">Attend a meeting</a><a href="${b}commission-actions/">Look up a decision</a><a href="${b}active-projects/">Explore city projects</a></nav><nav aria-label="Connect"><strong>Stay connected</strong><a href="https://www.instagram.com/davidsuarezmb/" target="_blank" rel="noreferrer">David on Instagram</a><a href="https://www.instagram.com/suarezsoundoff/" target="_blank" rel="noreferrer">Suarez Sound Off on Instagram</a><a href="https://www.tiktok.com/@suarezsoundoff" target="_blank" rel="noreferrer">Suarez Sound Off on TikTok</a><a href="https://www.youtube.com/@CommissionerDavidSuarez" target="_blank" rel="noreferrer">YouTube channel</a></nav></div><div class="hub-footer-bottom"><p>Official City records remain authoritative.</p><a href="${b}sources/">Data coverage & corrections</a><a href="mailto:david@miamibeachfl.gov">Contact the office</a></div></div></footer>`;
}
...
const pages = {
 ...
 'sources': page('sources','Sources, coverage & updates','See where the resident hub gets its information, when it was checked, what is covered and how to report a correction.',head('Sources & updates','')+`<section class="page-body"><div class="container"><div class="two-column"><div><div class="section-heading"><h2>Data coverage</h2></div><div id="source-status">${loading}</div></div><aside><div class="help-box"><h2>How updates work</h2><p>The publishing workflow is scheduled to check public feeds every six hours. New agendas, approved minutes, videos and City updates appear after a successful refresh and publication.</p><p>A “last checked” date means the source was retrieved. It does not mean the underlying record was newly published. If a source fails, the last saved snapshot stays available.</p></div><div class="help-box"><h2>Three different kinds of content</h2><p><strong>City records:</strong> official agendas, approved minutes, registries, announcements and GIS project data.</p><p><strong>Navigation aids:</strong> searchable titles, extracted vote labels and resident guides. These help you find a source; they are not legal findings.</p><p><strong>David’s perspective:</strong> his videos and social posts, presented as commentary from the commissioner.</p></div></aside></div><div class="notice"><strong>Important limitations</strong><p>Agenda short titles and sponsorship metadata come through the third-party Miami Beach Agenda navigator. Vote labels are extracted from approved minutes and may not capture every motion. “No amendment identified” is not proof that no language changed. Project map points may represent the center of a larger work area. Always consult the linked official record before relying on a summary.</p></div><div class="two-column"><div class="help-box"><h2>Privacy & accessibility</h2><p>Page-specific filters run in your browser. Your display preference is stored on this device. Optional address lookup sends the submitted address to Esri. This site has no signup database or advertising trackers. Loading a YouTube player connects to YouTube; project-map tiles connect to OpenStreetMap. Neighborhood boundaries come from the City’s public GIS. Fonts and video thumbnails also load from external services.</p><p>We aim for keyboard-accessible controls, visible focus, readable contrast and reduced-motion support. If something prevents you from using the site, please tell the office which page and device were affected.</p></div><div class="help-box"><h2>Something doesn’t look right?</h2><p>Send the page link, meeting date and item number if applicable. Corrections should be checked against the underlying City document.</p><a href="mailto:david@miamibeachfl.gov?subject=Resident%20hub%20correction">Send a correction to the office</a><p>For an official public-records request, use the City Clerk’s process—not this email link.</p><a href="https://www.miamibeachfl.gov/egovapp/city-hall/cityclerkdepartment/public-records/" target="_blank" rel="noreferrer">Official public records ↗</a></div></div></div></section>`),
